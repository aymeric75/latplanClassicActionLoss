...
class BaseActionMixinAMA4Plus(BidirectionalMixin, BaseActionMixin):
    ...
    def _build_primary(self, input_shape):
        ...
        print(theaction.shape) # (24, )
        
        images_layer = Lambda(lambda x: x[:,:2])(x)


        _, x_pre, x_suc = dapply(images_layer)
        z, z_pre, z_suc = dapply(images_layer, self._encode)
        y, y_pre, y_suc = dapply(z, self._decode)
        # to generate a correct ELBO, input to action should be deterministic
        (l_pre,     ), _ = z_pre.variational_source # see Variational class
        (l_suc,     ), _ = z_suc.variational_source # see Variational class
        ...
        cosine_similarity = tf.reduce_sum(tf.multiply(reshaped_label_action, reshaped_action_layer), axis=1)
        #cosine_distance = tf.losses.cosine_distance(reshaped_label_action, reshaped_action_layer, axis=1)
        #tf.math.reduce_mean()
        mean_cosine_distance = 1.0 - tf.reduce_mean(cosine_similarity)

        # print(cosine_similarity.shape)
        # print(mean_cosine_distance)



        # # False
        # bce = tf.keras.losses.BinaryCrossentropy(from_logits=False)
        # actionLoss = bce(squeezed_action, action_input)
        # actionLoss *= 1000000

        # sum_actions = tf.math.reduce_sum(squeezed_action)
        # sum_inputs = tf.math.reduce_sum(action_input)
        ...
        #total_loss = (ama3_forward_loss1 + ama3_forward_loss2 + ama3_backward_loss1 + ama3_backward_loss2 + actionLoss)/5
        ...
        self.add_metric("mean_cosine_distance", mean_cosine_distance)

        # self.add_metric("action_layer0", theaction[0])
        # self.add_metric("action_layer1", theaction[1])
        # self.add_metric("action_layer2", theaction[2])
        # self.add_metric("action_layer3", theaction[3])
        # self.add_metric("action_layer4", theaction[4])
        # self.add_metric("action_layer5", theaction[5])
        # self.add_metric("action_layer6", theaction[6])
        # self.add_metric("action_layer7", theaction[7])
        # self.add_metric("action_layer8", theaction[8])
        # self.add_metric("action_layer9", theaction[9])
        # self.add_metric("action_layer10", theaction[10])
        # self.add_metric("action_layer11", theaction[11])
        # self.add_metric("action_layer12", theaction[12])
        # self.add_metric("action_layer13", theaction[13])
        # self.add_metric("action_layer14", theaction[14])
        # self.add_metric("action_layer15", theaction[15])
        # self.add_metric("action_layer16", theaction[16])
        # self.add_metric("action_layer17", theaction[17])
        # self.add_metric("action_layer18", theaction[18])
        # self.add_metric("action_layer19", theaction[19])
        # self.add_metric("action_layer20", theaction[20])
        # self.add_metric("action_layer21", theaction[21])
        # self.add_metric("action_layer22", theaction[22])
        # self.add_metric("action_layer23", theaction[23])

        # self.add_metric("squeezed_action0", squeezed_action[0])
        # self.add_metric("squeezed_action01", squeezed_action[1])
        # self.add_metric("squeezed_action02", squeezed_action[2])
        # self.add_metric("squeezed_action03", squeezed_action[3])
        # self.add_metric("squeezed_action04", squeezed_action[4])
        # self.add_metric("squeezed_action05", squeezed_action[5])
        # self.add_metric("squeezed_action06", squeezed_action[6])
        # self.add_metric("squeezed_action07", squeezed_action[7])
        # self.add_metric("squeezed_action08", squeezed_action[8])
        # self.add_metric("squeezed_action09", squeezed_action[9])
        # self.add_metric("squeezed_action10", squeezed_action[10])
        # self.add_metric("squeezed_action11", squeezed_action[11])
        # self.add_metric("squeezed_action12", squeezed_action[12])
        # self.add_metric("squeezed_action13", squeezed_action[13])
        # self.add_metric("squeezed_action14", squeezed_action[14])
        # self.add_metric("squeezed_action15", squeezed_action[15])
        # self.add_metric("squeezed_action16", squeezed_action[16])
        # self.add_metric("squeezed_action17", squeezed_action[17])
        # self.add_metric("squeezed_action18", squeezed_action[18])
        # self.add_metric("squeezed_action19", squeezed_action[19])
        # self.add_metric("squeezed_action20", squeezed_action[20])
        # self.add_metric("squeezed_action21", squeezed_action[21])
        # self.add_metric("squeezed_action22", squeezed_action[22])
        # self.add_metric("squeezed_action23", squeezed_action[23])


        #self.add_metric("sum_inputs", sum_inputs)
        # self.add_metric("sum_actions", sum_actions)
        # self.add_metric("actionLoss", actionLoss)
